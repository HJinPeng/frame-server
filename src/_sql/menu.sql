...
CREATE TABLE `menu` (
  ...
  `hidden_menu` tinyint(3) unsigned zerofill DEFAULT NULL COMMENT '1—隐藏 0—显示',
  `keep_alive` tinyint(3) unsigned zerofill DEFAULT NULL COMMENT '1—缓存 0—不缓存',
  `external_link` tinyint(3) unsigned zerofill DEFAULT NULL COMMENT '1—外链 0 —非外链',
  `external_link_content` text,
  `status` varchar(16) DEFAULT NULL COMMENT '1—启用 2—禁用',
  `parent_id` int(11) DEFAULT NULL,
  `deleted` tinyint(3) unsigned zerofill DEFAULT NULL COMMENT '1—删除 0—正常',
